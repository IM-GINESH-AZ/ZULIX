<h2 align="center"> <img src="https://raw.githubusercontent.com/IM_GINESH_AZ/ZULIX/refs/heads/main/files/Dx-codex.jpg" width="470" /> </h2>
...
```
apt update && apt upgrade -y ; pkg install git -y ; git clone https://github.com/IM_GINESH_AZ/ZULIX.git ; cd ZULIX/ ; chmod +x * ; bash install.sh
```

<details id="missing-code-coverage">
  <summary>Use Tool</summary>

##### How to use ZULIX Banner tools
